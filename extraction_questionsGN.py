...
def entiteesNommees(sentence):#question basée sur les entitée nommées
    ...
    motsCles=MotsCles.TotalMotsCles(sentence)
    organisation1={}
    organisation2={}
    organisation3={}
    localite1={}
    ...
    for j in range(n):
        ...
        for org1 in doc.ents:
            if org1.label_=="ORG" and org1.root.dep_=="obj":
                ...
                organisation1['question']="Qu'est ce que "+phrase1[0]+" ?"
        ...
        for org3 in doc.ents:
            if org3.label_=="ORG" and org3.root.dep_=="nmod":
                ...
                organisation3['question']="Quelle organisation "+phrase3[0]+" ?"
                organisation3['Réponse']=org3.text
        questions['organisations_complément']=organisation3
        ...
        for loc2 in doc.ents:
            if loc2.label_=="LOC" and loc2.root.dep_=="nmod":
                ...
                localite2['question']="Ou "+phrase5[0]+" ?"#ok
        ...
        for loc3 in doc.ents:
            if loc3.label_=="LOC" and loc3.root.dep_=="conj":
                ...
                localite3['question']="Dans quelle autre localité "+phrase6[1].replace(".","?")
        ...
        for per2 in doc.ents:
            if per2.label_=="MISC" and per2.root.dep_=="conj":
                ...
                periode2['question']="En quelle autre période "+phrase12[1].replace(".","?")
...
def groupeNominal(texte):
    ...
    for j in range(n):
        ...
        for ncmt in doc.noun_chunks:#OK
            if ncmt.root.pos_=="NOUN" and ncmt.root.dep_=="nmod" and ncmt.text in motsCles:#ok COS
                phrase5=phrases[j].split(ncmt.text)
                paire5['question']="Pourquoi"+phrase5[0]+" ?"
                paire5['réponse'] = ncmt.text
                paire['nom_temps']=paire5
        
        for Q in doc.noun_chunks:#OK
            if Q.root.pos_=="PROPN" and Q.root.dep_=="nmod" and Q.text in motsCles:#ok
                phrase6=phrases[j].split(Q.text)
                paire6['question']="Quel "+phrase6[1].replace(".","?")
...
texte1=text1.read()
print("nommées",entiteesNommees(texte1))
